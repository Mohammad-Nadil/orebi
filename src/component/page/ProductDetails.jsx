        ...
        <div className="productInformation w-[780px] flex flex-col gap-y-7">
          ...
          <div >
            ...
            <div>
                <ul className="mt-6">
                    <li>
                        <p onClick={()=>setAccordion(!accordion)} className="font-DM font-bold leading-6 text-primary ">FEATURES  & DETAILS</p>
                        <div className={`transition-all duration-400 ${accordion?"h-auto overflow-auto py-5":"h-0 overflow-hidden p-0"}`} >
                            <h2>Lorem ipsum dolor sit amet !</h2>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis voluptate consequuntur minima doloribus, necessitatibus qui dolores aspernatur molestiae dolor, delectus consectetur quas autem! Similique fugiat, optio quas omnis aliquam exercitationem.</p>
                        </div>
                    </li>
                </ul>
            </div>
