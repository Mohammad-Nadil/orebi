    ...
    <>
      <nav className="bg-gray-200 ">
        <Container className=" py-4 md:py-8 px-3 md:px-0  flex justify-end gap-x-3 md:gap-x-0 md:justify-center  bg-gray-200">
          <Image
            className=" absolute top-1/2 -translate-y-1/2 left-3 md:left-0 "
            href="/"
            src={logo}
            alt="/Logo.png"
          />
            ...
            <ul className={`transition-all duration-500 md:static gap-x-10  flex absolute left-0 top-full md:flex-row flex-col md:justify-center md:bg-transparent w-full px-3 md:px-0 z-20 bg-inherit ${show?" translate-y-0 ":" top-0  -translate-y-full"} `}>
