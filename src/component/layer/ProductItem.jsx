...
const Li = ({ liText, icon }) => {
  return (
    <li className="flex justify-end items-center gap-x-4 ">
      <p className="font-DM text-secondary hover:font-bold hover:text-primary hover:cursor-pointer transition-all duration-300  ">
        {liText}
      </p>
      {icon}
    </li>
    ...
    <div className={` w-[23.125rem] ${className}`}>
      ...
      <div className="text">
        <div className="flex justify-between">
          <p className="text-primary font-DM text-xl font-bold">{pName}</p>
